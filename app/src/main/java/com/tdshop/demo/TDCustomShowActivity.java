...
public class TDCustomShowActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    mCustomCreativeView.setCreateListener(new CreativeViewListener() {
      @Override
      public void onCreativeError(TDShopException exception) {
        Log.e("CustomCreativeView", exception.getMessage());
        Toast.makeText(TDCustomShowActivity.this, exception.getMessage(), Toast.LENGTH_SHORT).show();
      ...
      public void onCreativeLoaded(View view) {
        ...
        Toast.makeText(TDCustomShowActivity.this, "CustomCreativeView Loaded", Toast.LENGTH_SHORT).show();
      }
    ...
    mLoadBt.setOnClickListener(new OnClickListener() {
      @Override
      public void onClick(View v) {
        if (!TDShop.isSdkInitialized()){
          Toast.makeText(TDCustomShowActivity.this, "init sdk first", Toast.LENGTH_SHORT).show();
          return;
        }
